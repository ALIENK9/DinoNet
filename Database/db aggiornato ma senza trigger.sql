...
(13, 'aaa', 'bbb', 'ccc1', '', NULL, 0, 'ddd', '2017-11-26', 'dino@dinosauro.it'),
...
(22, 'prova campi incompleti', '', 'prova campi incompleti', NULL, NULL, 0, '', '0000-00-00', 'admin@admin.it'),
(23, 'prova campi incompleti', '', 'prova campi incompleti', NULL, NULL, NULL, '', NULL, 'admin@admin.it'),
(24, 'ciao', '', 'ciao', 'ciao', NULL, NULL, '', '2018-01-21', 'admin@admin.it'),
(26, 'prova', 'sadfasdfas', 'ciasdofasdfdf gsdfgsdfmgsdof gsdfg sdfgsdf gsd fg sdf', 'sdfgsdfg sdf gsdf gs df gsd fg', '/img/articleimg/.png', NULL, 'prova', '2018-01-21', 'admin@admin.it'),
(27, 'csdfgsdfg', 'asdfgsfd', 'asdfsdfgv sdfg sdfg sdfh sdf', 'sdfgsdfg', '/img/articleimg/27.png', NULL, 'asdfadsf', '2018-01-21', 'admin@admin.it');
...
--
-- Dump dei dati per la tabella `commentodinosauro`
--

INSERT INTO `commentodinosauro` (`id`, `idutente`, `iddinosauro`, `commento`) VALUES
(2, 'admin@admin.it', 'Stegosaurus', 'come stai?\r\n'),
(3, 'admin@admin.it', 'Stegosaurus', 'ASDF'),
(4, 'admin@admin.it', 'Stegosaurus', 'ASDF'),
(5, 'admin@admin.it', 'Stegosaurus', 'ASDFSDFG'),
(6, 'admin@admin.it', 'Stegosaurus', 'FDHDFHFMG'),
(7, 'admin@admin.it', 'Stegosaurus', 'dfhdfhgdfhd'),
(8, 'admin@admin.it', 'Stegosaurus', 'nfcv xcv b'),
(9, 'admin@admin.it', 'Stegosaurus', 'j.k,hmghk.j');
...
CREATE TABLE `dinosauro` (
  ...
  `habitat` text,
  `alimentazione` text,
  `tipologiaalimentazione` enum('carnivoro','onnivoro','erbivoro','') DEFAULT 'onnivoro',
...
('prova dino', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'onnivoro', '', '', NULL, NULL, '0000-00-00', 'admin@admin.it'),
...
(28, '1', '2018-01-15'),
(29, 'prova', '2018-01-17'),
(30, 'Stegosaurus', '2018-01-18'),
(31, 'eee', '2018-01-20'),
(32, 'n', '2018-01-21'),
(33, 'prova', '2018-01-22'),
(34, 'Coelophysis', '2018-01-31');
...
('biancocomeilvino@hotmail.com', 'biancoc', 'vino', '1937-01-08', 'bianco', 0, NULL),
('ciao2@ciao.it', 'ciao', 'ciao', '0000-00-00', 'ciao', 0, NULL),
('ciao3@ciao.it', 'ciao', 'ciao', '1111-11-11', 'ciao', 1, NULL),
('ciao4@ciao.it', 'ciao', 'ciao', '1111-11-11', 'ciao', 0, NULL),
('ciao5@ciao.it', 'ciao', 'ciao', '0000-00-00', 'ciao', 0, NULL),
('CIAOcome@af.it', 'ciao', 'ciao', '0000-00-00', 'ciao', 0, NULL),
...
('prova@prova.it', 'prova1', 'cosa2', '2003-11-01', 'prova4', 1, NULL),
