				...
				<div class="card colored wrap-padding">
					<form action="'.$url.'?id=article&sez=add" method="POST" enctype="multipart/form-data" onsubmit="return validateForm(this)">
						...
						<p>
                            ...
                            <input type="number" id="eta" name="eta" data-validation-mode="unsigned" value="" required>
						</p>
				...
				<div class="padding-12 content">						
					...
					<div class="card colored wrap-padding">
						<form action="'.$url.'?id=article&sez=update" method="POST" enctype="multipart/form-data" onsubmit="return validateForm(this)">
							...
							<p>
                                <label for="eta">Età in milioni di anni</label>
                                <input type="number" id="eta" name="eta" data-validation-mode="unsigned" value="'.$row["eta"].'" required>
							</p>
