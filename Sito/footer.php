...
<footer class="colored padding-3">
	<div class="content center">
        ...
        <p>
            ...
            I testi descrittvi di ciascun dinosauro sono stati presi prevalentemente dai libri
        ...
        <noscript>
            <div class="card white wrap-padding hide-large">
                <h2>Hai disabilitato JavaScript :(</h2>
                <p>Per visualizzare il menù devi attivare JavaScript! In alternativa puoi continuare a navigare da questi link</p>
            </div>
        </noscript>
